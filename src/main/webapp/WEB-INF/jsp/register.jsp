...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form:form class="form" modelAttribute="registerForm" role="form">
			...
			<div class="form-group">
				<form:label path="accountNumber"><spring:message code="registerForm.form.accountNumber" /></form:label>
				<spring:message code="registerForm.form.accountNumber.placeholder" var="accountNumberPlaceholder" />
				<form:password path="accountNumber" class="form-control" placeholder="${accountNumberPlaceholder}" />
